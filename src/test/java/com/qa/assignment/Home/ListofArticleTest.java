...
public class ListofArticleTest extends TestBase {
	...
	@Test(description="TestListofArticle" )
 public void TestListofArticles() throws InterruptedException {
		//extentTest = extent.startTest("TestListofArticles");   
		signInPOM=homePOM.signinbutton();
		homePOM   = SignInPOM.signin();
		profilePOM =homePOM.Baseuser();
		profilePOM=ProfilePOM.Listofarticles();
	...
	@Test(description="TestPagenation" )
	 public void TestPagenation() throws InterruptedException {
		//extentTest = extent.startTest("TestPagenation");   
		signInPOM=homePOM.signinbutton();
		homePOM   = SignInPOM.signin();
		profilePOM =homePOM.Baseuser();
		profilePOM=ProfilePOM.Pagenation();
		//homePOM=HomePOM.Pagenation();
