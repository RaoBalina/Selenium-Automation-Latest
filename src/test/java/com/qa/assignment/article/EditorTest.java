...
public class EditorTest extends TestBase {
	...
	@Test(dataProvider = "getnewarticleTestdata" ,description="TestEditor" )
	public void TestEditor (String articletitle,String articleabout,String textarea,String entertags ) throws InterruptedException {
		//extentTest = extent.startTest("TestEditor");
