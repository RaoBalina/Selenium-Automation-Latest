...
public class DeleteArticleTest extends TestBase {
	...
	@DataProvider()
	public Object[][] DeletenewarticleTestdata() {
		Object[][] data = TestUtils.getTestData(Testdata);

		return data;

	}

	@Test(dataProvider = "DeletenewarticleTestdata",description="TestDeleteArticle"  )
	public void TestDeleteAtrticle (String articletitle,String articleabout,String textarea,String entertags ) throws InterruptedException {
	//	extentTest = extent.startTest("TestDeleteAtrticle");
		...
		homePOM =articlePOM.deletearticle();
