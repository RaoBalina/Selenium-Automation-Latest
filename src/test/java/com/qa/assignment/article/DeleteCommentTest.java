...
public class DeleteCommentTest extends TestBase {
	...
	@Test(dataProvider = "getnewarticleTestdata" ,description="TestDeleteComments" )
	public void TestDeletecomment (String articletitle,String articleabout,String textarea,String entertags ) throws InterruptedException {
		//extentTest = extent.startTest("TestDeletecomment");
		...
		articlePOM  =articlePOM.commentarea();
